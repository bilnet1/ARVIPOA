            ...
            <div className="relative bg-gradient-to-br from-gray-800/50 to-gray-900/80 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-gray-700/50">
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 flex items-end p-8">
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-2">ARVIPOA Smart Pillar Commercial</h3>
                    <p className="text-gray-200">Discover revolutionary IoT security technology transforming Africa</p>
                  </div>
                </div>

                {/* ARVIPOA Smart Pillar Commercial Video */}
                <iframe
                  ...
                  title="ARVIPOA Smart Pillar Commercial"
                  frameBorder="0"
              ...
              >
                <p className="text-lg text-gray-300 leading-relaxed">
                  "Watch our Smart Pillar technology in action - AI-powered surveillance, environmental monitoring, 
                  and autonomous threat detection revolutionizing property security across West Africa."
                </p>

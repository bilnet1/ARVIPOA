...
const milestones = [
  ...
  {
    year: "2024",
    title: "ARVIPOA Air Support Command",
    icon: <Cpu />,
    description: "Launched aerial monitoring using UAVs with thermal imaging, facial recognition, and automated AIR response to threats, fires, and intrusions.",

    ...
    const mockComments: Comment[] = [
      {
        ...
        content: 'This ARVIPOA Gen4 technology is revolutionary! The smart property protection features are exactly what Ghana needs.',
      ...
      },
      {
        ...
        author: 'Sarah Osei',
        authorAvatar: '/api/placeholder/30/30',
        content: 'The Gen-4 Turbo platform demo is incredible! When will this be available for my property in Accra?',
      ...
      },
      {
        ...
        author: 'Kwame Asante',
        authorAvatar: '/api/placeholder/30/30',
        content: 'ARVIPOA\'s Smart Pillar technology is the future of property security. Already planning to install one.',
